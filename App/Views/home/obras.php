...
<section class="projects-section">
    <div class="container">
        ...
        <div class="project-box iso-call">
            ...
            <div class="project-post buildings isolation">
                <a href="upload/projects/7.jpg" class="zoom"><img src="upload/projects/7.jpg" alt=""></a>
                <div class="hover-box">
                    <h2><a href="single-project.html">Elegant Building</a></h2>
                    <span>bulding, house</span>
                </div>
            ...
            <div class="project-post interior">
                <a href="upload/projects/8.jpg" class="zoom"><img src="upload/projects/8.jpg" alt=""></a>
                <div class="hover-box">
                    <h2><a href="single-project.html">Beatiful House</a></h2>
                    <span>interior</span>
                </div>
            ...
            <div class="project-post buildings isolation">
                <a href="upload/projects/9.jpg" class="zoom"><img src="upload/projects/9.jpg" alt=""></a>
                <div class="hover-box">
                    <h2><a href="single-project.html">Classic House</a></h2>
                    <span>bulding, isolation</span>
                </div>
