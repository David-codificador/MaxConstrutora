                                ...
                                <div class="row ">
                                    ...
                                    <div class="form-group col-sm-12 col-md-4">
                                        <div class="col-sm-12 pt-30">
                                            ...
                                            <?= $viewVar['paginacao']['busca'] != '' ? 'Dados da busca: ' . $viewVar['paginacao']['busca'] . ' [<a href="' . LINK . 'servicos/listar">Limpar</a>]' : '' ?>
                                        </div>
                                    </div>                                
                                </div>
                                <thead>
                                    <tr>
                                        <th style="width: 50%">Tipo de Serviço</th>
                            ...
                            <nav class="text-right">
                                <ul class="pagination">
                                    ...
                                    ?>">
                                        <a <?php
                                        if ($pagina != 1) {
                                            echo 'href="' . LINK . 'avisos/listar/' . $viewVar['paginacao']['anterior'] . '/' . $viewVar["paginacao"]["busca"] . '"';
                                        }
                                        ?> aria-label="Previous">
                                    ...
                                    for ($i; $i < $fim; $i++) {
                                        ...
                                        ?>"><a href="<?= LINK ?>avisos/listar/<?= $i + 1 ?>/<?= $viewVar['paginacao']['busca'] ?>"><?= str_pad($i + 1, 2, "0", STR_PAD_LEFT); ?></a></li>
                                            <?php
                                        }
                                        ?>
                                    <li class="<?php
                                    ...
                                    ?>">
                                        ...
                                        if ($pagina != $total and $fim != 0) {
                                            echo 'href="' . LINK . 'avisos/listar/' . $viewVar['paginacao']['proxima'] . '/' . $viewVar["paginacao"]["busca"] . '"';
                                        }
                                        ?> aria-label="Next">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>
                        ...
                        *Uma vez excluido, um registro só poderá ser restaurado por um avisos.
                        <br><br>
...
<script>
    function buscar() {
        ...
        window.location.replace($("#link").val() + 'avisos/listar/' + busca);
    }
</script>