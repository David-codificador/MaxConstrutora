                            ...
                            <table class="table table-hover">
                                <div class="row ">
                                    <div class="form-group col-sm-12 col-md-8">
                                        ...
                                        <a href="<?= LINK ?>tipoAdministrador/cadastro" class="btn bg-gray btn-wide"><i class="fa fa-plus"></i>Cadastrar</a>
                                    </div>
