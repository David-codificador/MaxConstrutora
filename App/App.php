...
class App {
    ...
    public function __construct() {
        ...
        define('JSTEMPLATE',         RECURSO . 'js/template/');
        define('IMAGEM',             RECURSO . 'imagem/');

        define('CSSSITE',            RECURSO . 'cssSite/');
    ...
    public function url() {
        if (isset($_GET['url'])) {
            ...
            $path[0] = filter_var($path[0], FILTER_SANITIZE_URL);
            $path[1] = filter_var($path[1], FILTER_SANITIZE_URL);
